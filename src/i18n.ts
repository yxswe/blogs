...
const copy = {
  zh: {
    siteName: 'YANGXIAO / 研习录',
    navWriting: '文章', navAbout: '关于', navSource: '源代码',
    eyebrow: '工程 · AI · 系统思考',
    headlineA: '记录技术的', headlineB: '深层结构。',
    intro: '这里是 Yangxiao 的个人数字花园。我写 AI Agent、软件工程，以及那些值得被拆开看清的系统。',
  ...
  en: {
    ...
    intro: "Yangxiao's personal digital garden—writing about AI agents, software engineering, and systems worth understanding from the inside out.",
